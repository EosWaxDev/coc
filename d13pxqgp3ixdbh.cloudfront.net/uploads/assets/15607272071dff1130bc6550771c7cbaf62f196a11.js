!(function (e, t) {
  ...
  function n() {
    ...
    if (e && !q(document.body, c.iosfix)) {
      ...
      (document.body.style.top = -1 * t + "px"), M(document.body, c.iosfix);
    }
  }
  function o() {
    ...
    return new Promise(function (n, o) {
      ...
      var s = function (n) {
          switch ((n = n || e.input)) {
            ...
            case "radio":
              return (
                t.querySelector("." + c.radio + " input:checked") ||
                t.querySelector("." + c.radio + " input:first-child")
              );
            case "range":
          ...
          e.showLoaderOnConfirm && i.showLoading(),
            e.preConfirm
              ? e.preConfirm(t, e.extraParams).then(
                  ...
                  function (e) {
                    i.hideLoading(), e && i.showValidationError(e);
                  }
                )
        ...
        f = function (t) {
          ...
          switch (n.type) {
            ...
            case "mouseup":
              e.buttonsStyling &&
                (s
                  ? (a.style.backgroundColor = h(e.confirmButtonColor, -0.1))
                  : c &&
                    (l.style.backgroundColor = h(e.cancelButtonColor, -0.1)));
              break;
            case "mouseout":
              e.buttonsStyling &&
                (s
                  ? (a.style.backgroundColor = e.confirmButtonColor)
                  : c && (l.style.backgroundColor = e.cancelButtonColor));
              break;
            case "mousedown":
              e.buttonsStyling &&
                (s
                  ? (a.style.backgroundColor = h(e.confirmButtonColor, -0.2))
                  : c &&
                    (l.style.backgroundColor = h(e.cancelButtonColor, -0.2)));
              break;
            case "click":
              if (s && i.isVisible())
                if (e.input) {
                  ...
                  e.inputValidator
                    ? (i.disableInput(),
                      e.inputValidator(d, e.extraParams).then(
                        function () {
                          i.enableInput(), p(d);
                        },
                        function (e) {
                          i.enableInput(), e && i.showValidationError(e);
                        }
                      ))
                    : p(d);
                } else p(!0);
              else c && i.isVisible() && (i.closeModal(e.onClose), o("cancel"));
          }
        },
      ...
      e.reverseButtons
        ...
        (i.hideLoading = i.disableLoading =
          function () {
            e.showConfirmButton || (O(g), e.showCancelButton || O(k())),
              T(g, c.loading),
              T(t, c.loading),
              (g.disabled = !1),
              (b.disabled = !1);
        ...
        if ((C = s(q[d]))) {
          for (var K in C.attributes)
            if (C.attributes.hasOwnProperty(K)) {
              ...
              "type" !== R && "value" !== R && C.removeAttribute(R);
            }
      ...
      ("select" !== e.input && "radio" !== e.input) ||
        ...
        "undefined" == typeof MutationObserver ||
          ...
          m.observe(t, { childList: !0, characterData: !0, subtree: !0 }));
    });
  }
  function i() {
    var e = arguments;
      ...
      if (!document.getElementsByClassName(c.container).length) {
        ...
        return (
          ...
          (t.onkeyup = function (e) {
            e.stopPropagation(), 13 === e.keyCode && i.clickConfirm();
          }),
          (n.onchange = function () {
            i.resetValidationError();
          }),
          (o.oninput = function () {
            i.resetValidationError(), (o.previousSibling.value = o.value);
          }),
          (o.onchange = function () {
            i.resetValidationError(), (o.previousSibling.value = o.value);
          }),
      ...
      t ? (M(r, c.show), M(a, c.fade), T(r, c.hide)) : T(r, c.fade),
        ...
        K && !q(r, c.noanimation)
          ? r.addEventListener(K, function i() {
              r.removeEventListener(K, i), (a.style.overflowY = "auto");
            })
  ...
  return (
    ...
    (i.queue = function (e) {
      ...
      return new Promise(function (e, o) {
        !(function r(a, l) {
          a < Y.length
            ? (t.setAttribute("data-queue-step", a),
              i(Y[a]).then(
                function () {
                  r(a + 1, l);
                },
